      ...
      <div className="md:col-span-3 flex items-center justify-center relative ">
        ...
        <div className="relative bg-white shadow-xl rounded-lg p-4 flex flex-col justify-center gap-2 max-w-[250px] mx-auto -mt-12">
          <div className="flex items-center">
            <img src="foto1.avif" className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 bg-white" />
            <img src="foto2.avif" className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4 bg-white" />
            <img src="foto3.avif" className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4 bg-white" />
            <img src="foto4.avif" className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4 bg-white" />
            <img src="foto5.avif" className="w-10 h-10 object-cover rounded-full ring-2 ring-gray-300 -ml-4 bg-white" />
          </div>
        ...
        <div className="absolute -right-14 -bottom-14 -z-10">
          ...
          <div className="absolute -left-2 -top-2 bg-white w-14 h-14"></div>
          </div>
        </div>
        </div>
        </div>
         {/* Circle */}
        <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[280px] h-[280px] md:w-[380px] md:h-[380px] bg-white border-[10px] border-primary rounded-full -z-10">
        </div>
        {/* Logos */}
        <img src="figma.png" className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-l-8 border-gray-600 absolute top-[12%] right-[20%] xl:right-[10%]"/>
        <img src="adobe.png" className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full border-l-8 border-gray-600 absolute top-[10%] left-[20%] xl:top-[2%] xl:left-[10%]"/>
        <img src="sketch.png" className="w-10 h-10 md:w-20 md:h-20 object-cover rounded-full  absolute bottom-[5%] left-[15%] xl:left-[3%] -rotate-12"/>
